...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if(!code) return message.channel.send('Well. What the fuck do you want me to eval? Do i need to teach you how to eval? Try doing this since you don\'t know how to eval \`?eval message.channel.send(\'hi\')\` BOOM there')
